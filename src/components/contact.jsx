...
function Contact() {
    return (
        <>
            <section className="contact-section anime mt-5">
                <div className="container">
                    <h2 className="section-title1">Keep In Touch With Us</h2>
                    <p className="section-subtitle">
                        Following are the best punch lines for fashion boutique and <br /> Keep calm & surround yourself with fashion
                    </p>
                    <div className="row contact-boxes">
                        ...
                        <div className="contact-col">
                            <div className="contact-box bg-transparent border-0">
                                ...
                                <h5>Address</h5>
                                <p>Pumo Technologies, 3nd Floor,</p>
                                <p className="mb-4">Gandhipuram, Coimbatore - 01.</p>
                                <a href="#" target='_blank' rel="noopener noreferrer" className="link">Get Direction</a>
                            </div>
                        </div>

                        {/* contact */}
                        <div className="contact-col anime">
                            <div className="contact-box bg-transparent border-0">
            ...
            <div className="contact-page anime">
                {/* map section */}
                ...
                <div className="section anime message-section">
